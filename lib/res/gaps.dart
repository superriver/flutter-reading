...
//  );
  ...
  static Widget vLine({double width=2.0}){
     Widget vLine = VerticalDivider(width: 10,indent: 4,endIndent: 4,thickness:width);
    return vLine;
  }

  static const Widget empty = const SizedBox();

  static Widget hBLine({double height=2}){
    Widget hBLine = Container(
      height: height,
